...
/* tslint:disable */
/* eslint-disable */
import type { Body_upload_files_api_v1_files_files_upload_post } from '../models/Body_upload_files_api_v1_files_files_upload_post';
...
export class FileUploadService {
     ...
     * @throws ApiError
     */
    public static uploadFilesApiV1FilesFilesUploadPost({
        formData,
    }: {
        formData: Body_upload_files_api_v1_files_files_upload_post,
    }): CancelablePromise<Array<FileUploadStatusSchema>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/files/files/upload',
            formData: formData,

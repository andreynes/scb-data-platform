...
# Импорты схем
from backend.app.schemas.admin_schemas import ReparseRequestSchema, ReparseResponseSchema
from backend.app.schemas.user_schemas import UserSchema
from backend.app.schemas.verification_schemas import (
    VerificationDataSchema, # Добавлено
    VerificationResultSchema,
    VerificationTaskSchema,
)

# Импорты сервисов и зависимостей
from backend.app.services.admin_service import AdminService
from backend.app.api.v1.deps import get_admin_service, get_current_admin_user
...
# <<< НАЧАЛО НОВЫХ/ОБНОВЛЕННЫХ ЭНДПОИНТОВ >>>
@router.get(
    "/verification/queue",
...
# <<< КОНЕЦ НОВЫХ/ОБНОВЛЕННЫХ ЭНДПОИНТОВ >>>